...
public final class TealiumHelper {
    ...
    public static void initialize(Application application) {
        ...
        final Tealium.Config config = Tealium.Config.create(application, "services-bryan", "mobile", "prod", "z8mwun");
        ...
        final Tealium instance = Tealium.createInstance("services-bryan", config);
